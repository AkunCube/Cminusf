  ...
  switch (op) {
    case Instruction::add:
      return ConstantInt::get(
          get_const_int_value(value1) + get_const_int_value(value2), module_);
    ...
    case Instruction::fadd:
      return ConstantFP::get(
          get_const_fp_value(value1) + get_const_fp_value(value2), module_);
...
Constant *ConstFolder::compute(Instruction *instr, Constant *value1) {
  ...
  switch (op) {
    case Instruction::sitofp:
      return ConstantFP::get(static_cast<float>(get_const_int_value(value1)),
                             module_);
    case Instruction::fptosi:
      return ConstantInt::get(static_cast<int>(get_const_fp_value(value1)),
                              module_);
    case Instruction::zext:
      return ConstantInt::get(static_cast<int>(get_const_int_value(value1)),
                              module_);
    default:
      return nullptr;
  }
